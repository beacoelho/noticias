    ...
    <form action="/noticias" method="POST">
        ...
        <h4>Atualização de Notícias</h4>              
            ...
            <div class="form-group">
                ...
                <textarea name="conteudo" rows="5" class=form-control placeholder="Informe o conteúdo da noticia"></textarea>
            </div>
